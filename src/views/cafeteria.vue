        ...
        <q-card flat bordered>
          ...
          <q-card-section class="text-center q-pa-md">
            <q-avatar size="80px" class="q-mb-sm shadow-2">
              <img src="../img/cafeteriachica.jpeg" alt="Laura Carreño" />
            </q-avatar>
            <div class="text-h6 text-weight-bold text-grey-9">Laura Carreño</div>
            <q-chip color="primary" text-color="white" size="sm" class="q-mb-xs">Coordinadora de Cafetería</q-chip>
